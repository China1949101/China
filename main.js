  ...
  items: [
    {
      label: '文件',
      submenu: [
        { label: '新建文件', accelerator: 'CmdOrCtrl+N', click: function() {} },
        { label: '打开文件', accelerator: 'CmdOrCtrl+O', click: function() {} },
        { label: '保存', accelerator: 'CmdOrCtrl+S', click: function() {} },
        { type: 'separator' },
    ...
    },
    {
      label: '帮助',
      submenu: [
        { label: '关于 AI Compiler', click: function() {} }
      ]
    }
  ]
});
...
console.log('AI Compiler Native App Started');
